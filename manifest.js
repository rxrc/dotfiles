...
const symlinks = async () => [
  ...
  },
  {
    ...
    dst:
      (await randomFile("drive/wallpaper/hosts/frigg")) ??
  ...
  },
  {
    src: ".config/awesome/themes/powerarrow-dark/wall.png",
    dst:
      (await randomFile("drive/wallpaper/hosts/mjolnir")) ??
      ".config/awesome/themes/powerarrow/wall.png",
  ...
  },
  {
    src: ".config/awesome/themes/powerarrow-dark/wall.png-2",
    dst:
      (await randomFile("seam/drive/wallpaper/freyja/vert")) ??
      ".config/awesome/themes/powerarrow/wall.png",
    hosts: ["freyja"],
    pkgs: ["awesome"],
  },
  {
    src: ".config/awesome/themes/powerarrow-dark/wall.png",
    dst:
      (await randomFile("seam/drive/wallpaper/freyja")) ??
      ".config/awesome/themes/powerarrow/wall.png",
    hosts: ["freyja"],
    pkgs: ["awesome"],
  },
